...
public class LimeLight extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Field X", getBlueFieldX());
    SmartDashboard.putNumber("Field Y", getBlueFieldY());
    SmartDashboard.putNumber("Field Rot", getBlueFieldRot());
  ...
  public double getBlueFieldRot(){
    ...
    return (table.getEntry("botpose_wpiblue").getDoubleArray(new double[6])[5]);
  }
  
  public double getBlueFieldX(){
    
    return (table.getEntry("botpose_wpiblue").getDoubleArray(new double[6])[0]);
  }
  public double getBlueFieldY(){
    
    return (table.getEntry("botpose_wpiblue").getDoubleArray(new double[6])[1]);
  }
